import{c as p,b as l,u as r,i as V,g as u,f as k,h as rt,e as h,j as F,o as v,k as ct,l as ut,H as N,D as mt,s as W,m as pt,d as Q}from"./vidstack-sKeoTFgw-FiP2mJ__.js";import{e as vt,x as i,c as ht,t as ft,l as _,D as $t,o as gt,L as K}from"./vidstack-jSFcERHu-HpyF4JIe.js";import{K as bt}from"./app-HFzAQKfX.js";class yt extends ht{constructor(t){super(t),this.h=null,this.ra=null,this.w=!1,this.w=t.type===ft.ATTRIBUTE}render(t){this.h!==t&&(this.h=t,this.disconnected(),this.isConnected&&this.Si());const s=this.h();return this.w?_(s):s}reconnected(){this.Si()}disconnected(){var t;this.w||this.setValue(null),(t=this.ra)==null||t.call(this),this.ra=null}Si(){this.h&&(this.ra=h(this.o.bind(this)))}o(){var t;this.setValue((t=this.h)==null?void 0:t.call(this))}}const c=vt(yt);function n(e){return c(p(e))}class U{constructor(t,s){this.Wj=t,this.Ca=s,this.elements=new Set,this.vf=F(this.ea.bind(this))}connect(){this.ea();const t=new MutationObserver(this.vf);t.observe(this.Wj,{childList:!0}),v(()=>t.disconnect()),v(this.disconnect.bind(this))}disconnect(){this.elements.clear()}assign(t,s){t instanceof Node?(s.textContent="",s.append(t)):$t(t,s),s.style.display||(s.style.display="contents");const a=s.firstElementChild;if(!a)return;const d=s.getAttribute("data-class");d&&a.classList.add(...d.split(" "))}ea(){for(const t of this.Wj.querySelectorAll("slot"))t.hasAttribute("name")&&this.elements.add(t);this.Ca(this.elements)}}let kt=0,y="data-slot-id";class Z{constructor(t){this.Wj=t,this.vf=F(this.ea.bind(this)),this.slots=new U(t,this.ea.bind(this))}connect(){this.slots.connect(),this.ea();const t=new MutationObserver(this.vf);t.observe(this.Wj,{childList:!0}),v(()=>t.disconnect())}ea(){for(const t of this.Wj.children){if(t.nodeType!==1)continue;const s=t.getAttribute("slot");if(!s)continue;t.style.display="none";let a=t.getAttribute(y);a||t.setAttribute(y,a=++kt+"");for(const d of this.slots.elements){if(d.getAttribute("name")!==s||d.getAttribute(y)===a)continue;const m=document.importNode(t,!0);s.includes("-icon")&&m.classList.add("vds-icon"),m.style.display="",m.removeAttribute("slot"),this.slots.assign(m,d),d.setAttribute(y,a)}}}}function C({label:e,icon:t}){return i`
  ...
  `}const G=class G extends N(K,mt){onSetup(){this.forwardKeepAlive=!1,this.a=r(),this.classList.add("vds-audio-layout"),this.menuContainer=tt("vds-audio-layout"),h(()=>{this.menuContainer&&W(this.menuContainer,"data-size",this.isSmallLayout&&"sm")}),v(()=>{var t;return(t=this.menuContainer)==null?void 0:t.remove()})}onConnect(){h(()=>{this.$props.customIcons()?new Z(this).connect():new et(this).connect()})}_j(){const{streamType:t}=this.a.$state;return this.isMatch&&t()!=="unknown"?this.isSmallLayout?jt():Mt():null}render(){return i`${n(this._j.bind(this))}`}};G.tagName="media-audio-layout";let M=G;function Gt(){return i`
    ${at()}${B()}
    <media-captions class="vds-captions"></media-captions>
  ...
  `}const O=class O extends N(K,pt){onSetup(){this.forwardKeepAlive=!1,this.a=r(),this.classList.add("vds-video-layout"),this.menuContainer=tt("vds-video-layout"),h(()=>{this.menuContainer&&W(this.menuContainer,"data-size",this.isSmallLayout&&"sm")}),v(()=>{var t;return(t=this.menuContainer)==null?void 0:t.remove()})}onConnect(){h(()=>{this.$props.customIcons()?new Z(this).connect():new et(this).connect()})}_j(){const{streamType:t}=this.a.$state;return this.isMatch?t()==="unknown"?B():this.isSmallLayout?Vt():Gt():null}render(){return i`${n(this._j.bind(this))}`}};O.tagName="media-video-layout";let j=O;Q(M);Q(j);
